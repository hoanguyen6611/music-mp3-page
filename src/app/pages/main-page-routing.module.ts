...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'account-me',
        loadChildren: async () =>
          (await import('./account/account.module')).AccountModule,
      ...
      },
      {
        path: 'category',
        loadChildren: async () =>
          (await import('./categorys/categorys.module')).CategorysModule,
      },
      {
        path: 'album',
        loadChildren: async () =>
      ...
      },
      {
        path: 'song',
        loadChildren: async () =>
          (await import('./song-detail/song-detail.module')).SongDetailModule,
      },
      {
        path: 'collection',
        loadChildren: async () =>
          (await import('./like-songs/like-songs.module')).LikeSongsModule,
        canActivate: [AuthGuard],
      },
    ],
  },
